...
if (!is_enabled_auth('ldapdawson')) {
    error_log('[AUTH LDAP] '.get_string('pluginnotenabled', 'auth_ldapdawson'));
    die;
}

$ldapauth = get_auth_plugin('ldapdawson');
//$ldapauth->sync_users(true); //do updates
$ldapauth->sync_users(false); //don't do updates
