...
/**
 * Strings for component 'enrol_cegep', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_cegep
...
$string['pluginname'] = 'Cegep database';
...
$string['remotesectionfield'] = 'Remote section field';
$string['remotesectionfield_desc'] = 'The name of the field in the remote table that we are using to find out what section the enrolment pertains to.';

$string['remoteuserfield'] = 'Remote user field';
$string['settingsheaderdb'] = 'Cegep database connection';
...
$string['groupingsections'] = 'Sections';
